 ...
 * @author mhardin
 */
public class AutomationNodeRegistryTask extends AbstractAutomationCleanupTask {

    private static final Logger log = LoggerFactory.getLogger(AutomationNodeRegistryTask.class);
    @VisibleForTesting
    static final String NAME = "Node Registry Task";
     ...
     */
    public AutomationNodeRegistryTask(RegistryRetriever registryRetriever) {
    ...
    public String getDescription() {
        return AutomationNodeRegistryTask.NAME;
    }
