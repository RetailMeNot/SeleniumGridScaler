 ...
 */
public class AutomationNodeRegistryTaskTest {
    ...
    public void testTaskName() {
        AutomationNodeRegistryTask task = new AutomationNodeRegistryTask(null);
        Assert.assertEquals("Name should be the same", AutomationNodeRegistryTask.NAME, task.getDescription());
    }
