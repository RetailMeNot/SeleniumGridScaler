...
* Internet Explorer - New t2.micro instances will be started capable of running 1 thread (test) per instance.  Note IE is not really fully supported yet, as Windows VMs take a while to come online and waiting logic will have to be implemented for them to come online.
